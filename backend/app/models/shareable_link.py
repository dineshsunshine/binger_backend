...
Allows users to create public shareable links to their watchlists
"""
...
class ShareableLink(Base):
    """Model for shareable watchlist links"""
    ...
    def __repr__(self):
        return f"<ShareableLink(user_id={self.user_id}, token={self.token}, is_active={self.is_active})>"
